<template>
  <div class="main-container">
    ...
    <div v-show="showMap" id="map">
      ...
      <NuxtLink
        v-if="!riddleCompleted"
        to="/games/riddle"
        class="hero-mini"
        :data-video="getAssetPath('hero_mini/wk.mp4')"
        :data-time="0"
    ...
    <div v-show="!showMap" class="menu">
      <CustomButton button-text="Мапа" size="large" @clicked="startGame" />
      <CustomButton button-text="Лавка" size="large" @clicked="startGame" />
    </div>
  </div>
</template>
